...
namespace LabProject.Labs
{
    public partial class Lab1Control : UserControl, ILabModule
    {
        ...
        {
            string message = "Метод дихотомии для поиска локального минимума функции\n\n" +
                     "Метод дихотомии (метод половинного деления) - это итерационный численный метод оптимизации для нахождения минимума функции на заданном интервале.\n\n" +
                     "Алгоритм работы:\n" +
                     "1. На каждой итерации интервал [a, b] делится на две части\n" +
                     "2. Сравниваются значения функции в точках x1 и x2\n" +
                     "3. Интервал сужается в зависимости от результатов сравнения\n" +
                     "4. Процесс продолжается до достижения заданной точности ε\n\n" +
                     ...
                     "• exp(x) - 2*x\n\n" +
                     "Параметры:\n" +
                     "• a, b - границы интервала поиска минимума (a < b)\n" +
                     "• ε - точность вычислений (ε > 0)\n\n" +
                     "Особенности:\n" +
                     "• Функция должна быть унимодальной на заданном интервале\n" +
                     "• Скорость сходимости линейная\n" +
                     "• Гарантированно находит минимум для непрерывных функций";
